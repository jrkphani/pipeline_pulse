"""
CRM Field Management API Endpoints
Handles Zoho CRM custom field management, permissions, and organization info
"""
...
router = APIRouter(prefix="/fields", tags=["CRM Field Management"])
