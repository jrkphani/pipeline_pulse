...
function Calendar({
  ...
  captionLayout = "label",
  buttonVariant: buttonVariantProp = "ghost",
  formatters,
  components,
  ...props
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        button_previous: cn(
          buttonVariants({ variant: buttonVariantProp }),
        ...
        day: cn(
          "relative h-full w-full p-0 text-center",
      ...
      components={{
        ...
        WeekNumber: ({ children, ...weekNumProps }) => (
          <td {...weekNumProps}>
            <span className="flex h-[--cell-size] w-[--cell-size] items-center justify-center text-[0.8rem]">
              {children}
            </span>
          </td>
        ),
